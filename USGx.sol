...
// --- Developer - EJS32
// --- @dev pragma solidity version:0.8.26
...
contract USGx is ERC20StorageFee, MinterRole, BurnerRole, Ownable, Feeless, GDToken {
    ...
    string public constant name = "USGold";
    string public constant symbol = "USGx";
